...
"""Generated protocol buffer code for snapshot submission."""
...
# Define the descriptor for the protocol buffer
...
# Set options for the descriptor if C descriptors are not used
if _descriptor._USE_C_DESCRIPTORS == False:
  _globals['DESCRIPTOR']._options = None
  _globals['DESCRIPTOR']._serialized_options = b'Z/github.com/PowerLoom/proto-snapshot-server/pkgs'

  # Set serialized start and end for each message type
